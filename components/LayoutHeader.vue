<template>
  <header class="w-full absolute md:static bg-black px-2 py-2 z-50">
    <div class="md:max-w-3xl mx-auto md:flex md:items-center">
      <div class="w-full md:flex mx-auto px-6 md:px-6 flex justify-between items-center h-16">
        <h1>
          <a
            href="/"
      ...
      <nav class="w-full md:block absolute left-0 md:static bg-black md:bg-none z-20" :class="isOpen ? 'block' : 'hidden'">
